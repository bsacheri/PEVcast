...
(function(){ try{ window.APP_VERSION='7.12.39'; console.info('[WeatherApp] app.js', window.APP_VERSION); }catch(e){} })();
const CODE_UPDATED = '04/29/2026 12:05 AM';
...
window.addEventListener('DOMContentLoaded', async ()=>{
  ...
  try { const elJs=$("ver-js"); if(elJs) elJs.textContent = `app.js v7.12.39`; } catch(e){ console.warn(e); }
